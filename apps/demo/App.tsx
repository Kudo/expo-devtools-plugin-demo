    ...
    <View style={{ flex: 1 }}>
      {currentDemo === null && (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <Button title="Apollo demo" onPress={() => setCurrentDemo('apollo')} />
          <Button title="Hello World demo" onPress={() => setCurrentDemo('hello')} />
          <Button title="Tinybase demo" onPress={() => setCurrentDemo('tinybase')} />
        </View>
      )}
